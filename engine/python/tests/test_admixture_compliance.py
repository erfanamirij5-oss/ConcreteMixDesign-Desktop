...
def test_c494_water_reducer_passes_standard_check_but_total_chloride_remains_partial():
    ...
    assert result["standard_checks"][0]["status"] == "pass"
...
def test_air_entrainer_requires_c260_designation():
    ...
    assert result["standard_checks"][0]["status"] == "needs_review"
