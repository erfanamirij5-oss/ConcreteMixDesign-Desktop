...
def calculate_integrated_normal_mix(payload: dict) -> dict:
    """Run durability and binder allocation before ACI proportioning."""
    ...
    result["calculation_pipeline"] = ["ACI_318_25_durability", "cementitious_multi_binder_allocation", "ACI_PRC_211_1_22_proportioning"]
    return result
