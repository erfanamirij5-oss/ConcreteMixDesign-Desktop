...
function payload(overrides: Partial<LicensePayload> = {}): LicensePayload {
  return {
    ...
    issuedAt: '2026-09-01T00:00:00.000Z', expiresAt: '2027-09-01T00:00:00.000Z', perpetual: false,
...
try {
  ...
  console.log('Gate 10 licensing smoke passed: production public key, Ed25519 verification, license states, feature enforcement, tamper/product/machine/expiry/schema rejection, safe replacement and clock rollback protection verified.');
